<template>
  <div class="politics">
    ...
    <div class="politics__content">
      ...
      веб-сайта https://zargee.ru/. 2. Основные понятия, используемые в Политике
      ...
      https://zargee.ru/. 2.4. Информационная система персональных данных —
      ...
      определенному или определяемому Пользователю веб-сайта https://zargee.ru/.
      ...
      2.10. Пользователь – любой посетитель веб-сайта https://zargee.ru/. 2.11.
      ...
      на веб-сайте https://zargee.ru/. 7.2. Также Оператор имеет право
      ...
      письмо на адрес электронной почты onyxmetaverse@gmail.com с пометкой
      «Отказ от уведомлений о новых продуктах и услугах и специальных
      предложениях». 7.3. Обезличенные данные Пользователей, собираемые с
      ...
      содержания. 8. Правовые основания обработки персональных данных 8.1.
      ...
      между оператором и субъектом персональных данных; – федеральные законы,
      ...
      персональных данных, разрешенных для распространения. 8.2. Оператор
      ...
      формы, расположенные на сайте https://zargee.ru/ или направленные
      ...
      свое согласие с данной Политикой. 8.3. Оператор обрабатывает обезличенные
      ...
      на адрес электронной почты Оператора onyxmetaverse@gmail.com с пометкой
      ...
      onyxmetaverse@gmail.com с пометкой «Отзыв согласия на обработку
      ...
      onyxmetaverse@gmail.com. 14.2. В данном документе будут отражены любые
      ...
      https://zargee.ru/settings/user/politics.
    </div>
  </div>
</template>
